package id.ac.poliban.mi.vb.e020320055.simplecalctestchallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Rizka - Simple Calc Test Challenge");
    ...
    public void onDiv(View view) {
        ...
        Toast.makeText(getApplicationContext(), "Enter Valid Numbers in Operand 2", Toast.LENGTH_SHORT).show();
    }
