package id.ac.poliban.mi.vb.e020320055.notifymechallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.vb.e020320055.notifymechallenge.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Rizka - Notify Me Challenge");
...
//    public void sendNotification() {    }
    ...
    public void notifyButton(View view) {
        ...
        notifyBuilder.addAction(R.drawable.ic_update, getString(R.string.update_notification),
                updatePendingIntent);
