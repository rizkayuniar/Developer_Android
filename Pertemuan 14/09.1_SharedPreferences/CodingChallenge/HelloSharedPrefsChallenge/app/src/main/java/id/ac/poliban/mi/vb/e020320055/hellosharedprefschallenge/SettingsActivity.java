package id.ac.poliban.mi.vb.e020320055.hellosharedprefschallenge;
...
public class SettingsActivity extends AppCompatActivity
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.vb.e020320055.hellosharedprefschallenge";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String savedSpinnerSetting = mPreferences.getString(SELECTED_SPINNER_ITEM_KEY,
                "Default");
